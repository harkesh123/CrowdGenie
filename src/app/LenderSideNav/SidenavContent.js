            ...
            <CustomScrollbars className=" scrollbar">
                <ul className="nav-menu">
                    ...
                    <li className="menu collapse-box">
                        ...
                        <ul className="sub-menu">
                            <li>
                                <NavLink className="prepend-icon" to="/Lender/table/basic">
                                    <span className="nav-text"><IntlMessages id="sidebar.tables.basicTable"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon" to="/Lender/table/data">
                    ...
                    <li className="timeline_tooltip menu">
                        ...
                        <ul className="sub-menu">
                            ...
                            <li>
                                <NavLink className="prepend-icon" to="/Lender/time-line/default">
                                    <span className="nav-text"><IntlMessages id="sidebar.timeLine.default"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon"
                                         to="/Lender/time-line/default-with-icon">
                                    <span className="nav-text"><IntlMessages
                            ...
                            <li>
                                <NavLink className="prepend-icon"
                                         to="/Lender/time-line/left-align">
                                    <span className="nav-text"><IntlMessages id="sidebar.timeLine.leftAligned"/></span>
                                </NavLink>
                            </li>
                            {/*<li>
                            <NavLink className="prepend-icon" to="/Lender/time-line/zigzag">
                    ...
                    <li className="menu">
                        ...
                        <ul className="sub-menu">
                            <li>
                                <NavLink className="prepend-icon"
                                         to="/Lender/custom-views/simple-list">
                                    <span className="nav-text"><IntlMessages
                            ...
                            <li>
                                <NavLink className="prepend-icon"
                                         to="/Lender/custom-views/strip-list">
                                    <span className="nav-text"><IntlMessages
                            ...
                            <li>
                                <NavLink className="prepend-icon"
                                         to="/Lender/custom-views/card-list">
                                    <span className="nav-text"><IntlMessages
                    ...
                    <li className="menu">
                        ...
                        <ul className="sub-menu">
                            <li>
                                <NavLink className="prepend-icon" to="/Lender/form/components">
                                    <span className="nav-text"><IntlMessages id="sidebar.forms.components"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon" to="/Lender/form/stepper">
                    ...
                    <li className="menu">
                        ...
                        <ul className="sub-menu">
                            <li>
                                <NavLink className="prepend-icon" to="/Lender/editor/ck">
                                    <span className="nav-text"><IntlMessages id="sidebar.editors.CKEditor"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon" to="/Lender/editor/wysiswyg">
                                    <span className="nav-text"><IntlMessages
                    ...
                    <li className="menu">
                        ...
                        <ul className="sub-menu">
                            <li>
                                <NavLink className="prepend-icon" to="/Lender/pickers/date-time">
                                    <span className="nav-text"><IntlMessages
                                        id="sidebar.pickers.dateTimePickers"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon" to="/Lender/pickers/color">
                    ...
                    <li className="menu">
                        ...
                        <ul className="sub-menu">
                            <li>
                                <NavLink className="prepend-icon" to="/Lender/chart/line">
                                    <span className="nav-text"><IntlMessages id="sidebar.chart.line"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon" to="/Lender/chart/bar">
                                    <span className="nav-text"><IntlMessages id="sidebar.chart.bar"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon" to="/Lender/chart/area">
                                    <span className="nav-text"><IntlMessages id="sidebar.chart.area"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon" to="/Lender/chart/composed">
                                <span className="nav-text"><IntlMessages
                                    id="sidebar.chart.composed"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon" to="/Lender/chart/scatter">
                                <span className="nav-text"><IntlMessages
                                    id="sidebar.chart.scatter"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon" to="/Lender/chart/pie">
                                    <span className="nav-text"><IntlMessages id="sidebar.chart.pie"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon" to="/Lender/chart/radial">
                                    <span className="nav-text"><IntlMessages id="sidebar.chart.radial"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon" to="/Lender/chart/radar">
                                    <span className="nav-text"><IntlMessages id="sidebar.chart.radar"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon" to="/Lender/chart/treemap">
