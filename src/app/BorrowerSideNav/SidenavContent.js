            ...
            <CustomScrollbars className=" scrollbar">
                <ul className="nav-menu">
                    ...
                    <li className="menu collapse-box">
                        ...
                        <ul className="sub-menu">
                            <li>
                                <NavLink className="prepend-icon" to="/Borrower/table/basic">
                                    <span className="nav-text"><IntlMessages id="sidebar.tables.basicTable"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon" to="/Borrower/table/data">
                    ...
                    <li className="timeline_tooltip menu">
                        ...
                        <ul className="sub-menu">
                            ...
                            <li>
                                <NavLink className="prepend-icon" to="/Borrower/time-line/default">
                                    <span className="nav-text"><IntlMessages id="sidebar.timeLine.default"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon"
                                         to="/Borrower/time-line/default-with-icon">
                                    <span className="nav-text"><IntlMessages
                            ...
                            <li>
                                <NavLink className="prepend-icon"
                                         to="/Borrower/time-line/left-align">
                                    <span className="nav-text"><IntlMessages id="sidebar.timeLine.leftAligned"/></span>
                                </NavLink>
                            </li>
                            {/*<li>
                            <NavLink className="prepend-icon" to="/Borrower/time-line/zigzag">
                    ...
                    <li className="menu">
                        ...
                        <ul className="sub-menu">
                            <li>
                                <NavLink className="prepend-icon"
                                         to="/Borrower/custom-views/simple-list">
                                    <span className="nav-text"><IntlMessages
                            ...
                            <li>
                                <NavLink className="prepend-icon"
                                         to="/Borrower/custom-views/strip-list">
                                    <span className="nav-text"><IntlMessages
                            ...
                            <li>
                                <NavLink className="prepend-icon"
                                         to="/Borrower/custom-views/card-list">
                                    <span className="nav-text"><IntlMessages
                    ...
                    <li className="menu">
                        ...
                        <ul className="sub-menu">
                            <li>
                                <NavLink className="prepend-icon" to="/Borrower/form/components">
                                    <span className="nav-text"><IntlMessages id="sidebar.forms.components"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon" to="/Borrower/form/stepper">
                    ...
                    <li className="menu">
                        ...
                        <ul className="sub-menu">
                            <li>
                                <NavLink className="prepend-icon" to="/Borrower/editor/ck">
                                    <span className="nav-text"><IntlMessages id="sidebar.editors.CKEditor"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon" to="/Borrower/editor/wysiswyg">
                                    <span className="nav-text"><IntlMessages
                    ...
                    <li className="menu">
                        ...
                        <ul className="sub-menu">
                            <li>
                                <NavLink className="prepend-icon" to="/Borrower/pickers/date-time">
                                    <span className="nav-text"><IntlMessages
                                        id="sidebar.pickers.dateTimePickers"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon" to="/Borrower/pickers/color">
                    ...
                    <li className="menu">
                        ...
                        <ul className="sub-menu">
                            <li>
                                <NavLink className="prepend-icon" to="/Borrower/chart/line">
                                    <span className="nav-text"><IntlMessages id="sidebar.chart.line"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon" to="/Borrower/chart/bar">
                                    <span className="nav-text"><IntlMessages id="sidebar.chart.bar"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon" to="/Borrower/chart/area">
                                    <span className="nav-text"><IntlMessages id="sidebar.chart.area"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon" to="/Borrower/chart/composed">
                                <span className="nav-text"><IntlMessages
                                    id="sidebar.chart.composed"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon" to="/Borrower/chart/scatter">
                                <span className="nav-text"><IntlMessages
                                    id="sidebar.chart.scatter"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon" to="/Borrower/chart/pie">
                                    <span className="nav-text"><IntlMessages id="sidebar.chart.pie"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon" to="/Borrower/chart/radial">
                                    <span className="nav-text"><IntlMessages id="sidebar.chart.radial"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon" to="/Borrower/chart/radar">
                                    <span className="nav-text"><IntlMessages id="sidebar.chart.radar"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon" to="/Borrower/chart/treemap">
                    ...
                    <li className="menu">
                        ...
                        <ul className="sub-menu">
                            ...
                            <li>
                                <NavLink className="prepend-icon"
                                         to="/Borrower/ecommerce/products-list">
                                    <span className="nav-text"><IntlMessages
                            ...
                            <li>
                                <NavLink className="prepend-icon"
                                         to="/Borrower/ecommerce/products-grid">
                                    <span className="nav-text"><IntlMessages
                    ...
                    <li className="menu">
                        ...
                        <ul className="sub-menu">
                            <li>
                                <NavLink className="prepend-icon" to="/Borrower/app-module/login-1">
                                    <span className="nav-text"><IntlMessages id="sidebar.appModule.login1"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon" to="/Borrower/app-module/login-2">
                            ...
                            <li>
                                <NavLink className="prepend-icon"
                                         to="/Borrower/app-module/login-with-stepper">
                                    <span className="nav-text"><IntlMessages
                            ...
                            <li>
                                <NavLink className="prepend-icon"
                                         to="/Borrower/app-module/forgot-password-2">
                                    <span className="nav-text"><IntlMessages
                            ...
                            <li>
                                <NavLink className="prepend-icon"
                                         to="/Borrower/app-module/lock-screen-1">
                                    <span className="nav-text"><IntlMessages id="sidebar.appModule.lock1"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon"
                                         to="/Borrower/app-module/lock-screen-2">
                    ...
                    <li className="menu no-arrow">
                        <NavLink to="/Borrower/to-do-redux">
                            <i className="zmdi zmdi-check-square zmdi-hc-fw"/>
                    ...
                    <li className="menu no-arrow">
                        <NavLink to="/Borrower/mail-redux">
                            <i className="zmdi zmdi-email zmdi-hc-fw"/>
                    ...
                    <li className="menu no-arrow">
                        <NavLink to="/Borrower/chat-redux">
                            <i className="zmdi zmdi-comment zmdi-hc-fw"/>
                    ...
                    <li className="menu no-arrow">
                        <NavLink to="/Borrower/contact-redux">
                            <i className="zmdi zmdi-account-box zmdi-hc-fw"/>
                    ...
                    <li className="menu">
                        ...
                        <ul className="sub-menu">
                            <li>
                                <NavLink className="prepend-icon" to="/Borrower/icons/material">
                    ...
                    <li className="menu">
                        ...
                        <ul className="sub-menu">
                            <li>
                                <NavLink className="prepend-icon"
                                         to="/Borrower/extra-elements/pricing-table">
                                <span className="nav-text"><IntlMessages
                            ...
                            <li>
                                <NavLink className="prepend-icon"
                                         to="/Borrower/extra-elements/callouts">
                                    <span className="nav-text"><IntlMessages
                            ...
                            <li>
                                <NavLink className="prepend-icon"
                                         to="/Borrower/extra-elements/testimonials">
                                <span className="nav-text"><IntlMessages
