                ...
                <ul className="nav-menu">
                    ...
                    <li className="menu collapse-box">
                        ...
                        <ul className="sub-menu">
                            <li>
                                <NavLink className="prepend-icon" to="/Admin/dashboard/default">
                            ...
                            <li>
                                <NavLink className="prepend-icon" to="/Admin/dashboard/news">
                                    <span className="nav-text"><IntlMessages id="sidebar.dashboard.news"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon" to="/Admin/dashboard/intranet">
                    ...
                    <li className="menu collapse-box">
                        ...
                        <ul className="sub-menu">
                            <li>
                                <NavLink className="prepend-icon" to="/Admin/table/basic">
                                    <span className="nav-text"><IntlMessages id="sidebar.tables.basicTable"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon" to="/Admin/table/data">
                    ...
                    <li className="timeline_tooltip menu">
                        ...
                        <ul className="sub-menu">
                            ...
                            <li>
                                <NavLink className="prepend-icon" to="/Admin/time-line/default">
                                    <span className="nav-text"><IntlMessages id="sidebar.timeLine.default"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon"
                                         to="/Admin/time-line/default-with-icon">
                                    <span className="nav-text"><IntlMessages
                            ...
                            <li>
                                <NavLink className="prepend-icon"
                                         to="/Admin/time-line/left-align">
                                    <span className="nav-text"><IntlMessages id="sidebar.timeLine.leftAligned"/></span>
                                </NavLink>
                            </li>
                            {/*<li>
                            <NavLink className="prepend-icon" to="/Admin/time-line/zigzag">
                    ...
                    <li className="menu">
                        ...
                        <ul className="sub-menu">
                            <li>
                                <NavLink className="prepend-icon"
                                         to="/Admin/custom-views/simple-list">
                                    <span className="nav-text"><IntlMessages
                            ...
                            <li>
                                <NavLink className="prepend-icon"
                                         to="/Admin/custom-views/strip-list">
                                    <span className="nav-text"><IntlMessages
                            ...
                            <li>
                                <NavLink className="prepend-icon"
                                         to="/Admin/custom-views/card-list">
                                    <span className="nav-text"><IntlMessages
                    ...
                    <li className="menu">
                        ...
                        <ul className="sub-menu">
                            <li>
                                <NavLink className="prepend-icon" to="/Admin/form/components">
                                    <span className="nav-text"><IntlMessages id="sidebar.forms.components"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon" to="/Admin/form/stepper">
                    ...
                    <li className="menu">
                        ...
                        <ul className="sub-menu">
                            <li>
                                <NavLink className="prepend-icon" to="/Admin/editor/ck">
                                    <span className="nav-text"><IntlMessages id="sidebar.editors.CKEditor"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon" to="/Admin/editor/wysiswyg">
                                    <span className="nav-text"><IntlMessages
                    ...
                    <li className="menu">
                        ...
                        <ul className="sub-menu">
                            <li>
                                <NavLink className="prepend-icon" to="/Admin/pickers/date-time">
                                    <span className="nav-text"><IntlMessages
                                        id="sidebar.pickers.dateTimePickers"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon" to="/Admin/pickers/color">
                    ...
                    <li className="menu">
                        ...
                        <ul className="sub-menu">
                            <li>
                                <NavLink className="prepend-icon" to="/Admin/chart/line">
                                    <span className="nav-text"><IntlMessages id="sidebar.chart.line"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon" to="/Admin/chart/bar">
                                    <span className="nav-text"><IntlMessages id="sidebar.chart.bar"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon" to="/Admin/chart/area">
                                    <span className="nav-text"><IntlMessages id="sidebar.chart.area"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon" to="/Admin/chart/composed">
                                <span className="nav-text"><IntlMessages
                                    id="sidebar.chart.composed"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon" to="/Admin/chart/scatter">
                                <span className="nav-text"><IntlMessages
                                    id="sidebar.chart.scatter"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon" to="/Admin/chart/pie">
                                    <span className="nav-text"><IntlMessages id="sidebar.chart.pie"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon" to="/Admin/chart/radial">
                                    <span className="nav-text"><IntlMessages id="sidebar.chart.radial"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon" to="/Admin/chart/radar">
                                    <span className="nav-text"><IntlMessages id="sidebar.chart.radar"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon" to="/Admin/chart/treemap">
                    ...
                    <li className="menu">
                        ...
                        <ul className="sub-menu">
                            ...
                            <li>
                                <NavLink className="prepend-icon"
                                         to="/Admin/ecommerce/products-list">
                                    <span className="nav-text"><IntlMessages
                            ...
                            <li>
                                <NavLink className="prepend-icon"
                                         to="/Admin/ecommerce/products-grid">
                                    <span className="nav-text"><IntlMessages
                    ...
                    <li className="menu">
                        ...
                        <ul className="sub-menu">
                            <li>
                                <NavLink className="prepend-icon" to="/Admin/app-module/login-1">
                                    <span className="nav-text"><IntlMessages id="sidebar.appModule.login1"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon" to="/Admin/app-module/login-2">
                            ...
                            <li>
                                <NavLink className="prepend-icon"
                                         to="/Admin/app-module/login-with-stepper">
                                    <span className="nav-text"><IntlMessages
                            ...
                            <li>
                                <NavLink className="prepend-icon"
                                         to="/Admin/app-module/forgot-password-2">
                                    <span className="nav-text"><IntlMessages
                    ...
                    <li className="menu no-arrow">
                        <NavLink to="/Admin/contact-redux">
                            <i className="zmdi zmdi-account-box zmdi-hc-fw"/>
                    ...
                    <li className="menu">
                        ...
                        <ul className="sub-menu">
                            <li>
                                <NavLink className="prepend-icon" to="/Admin/icons/material">
                    ...
                    <li className="menu">
                        ...
                        <ul className="sub-menu">
                            <li>
                                <NavLink className="prepend-icon"
                                         to="/Admin/extra-elements/pricing-table">
                                <span className="nav-text"><IntlMessages
                            ...
                            <li>
                                <NavLink className="prepend-icon"
                                         to="/Admin/extra-elements/callouts">
                                    <span className="nav-text"><IntlMessages
                            ...
                            <li>
                                <NavLink className="prepend-icon"
                                         to="/Admin/extra-elements/testimonials">
                                <span className="nav-text"><IntlMessages
